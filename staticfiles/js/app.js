...
(function () {
  $(".show__menu__button").click(function (e) {
    e.preventDefault();
    $(".setting__menu").addClass("show");
  });
  $(".close__menu__button").click(function (e) {
    e.preventDefault();
    $(".setting__menu").removeClass("show");
  });
})();
    ...
    dateRange.each(function () {
      ...
      _this.dateRangePicker({
        ...
        setValue: function setValue(s, s1, s2) {
          if (
            $(".js-date-from").attr("readonly") &&
            $(".js-date-to").attr("readonly")
          ) {
            $(".js-date-from").val(s1);
            $(".js-date-to").val(s2);
          } else {
...
(function () {
  ...
  head.on("click", function () {
    ...
    thisHead
      .parents(".faq__item, .faq1__item")
      .find(".faq__body, .faq1__body")
      .slideToggle();
  });
})(); // upload preview show
...
(function () {
  $(".collapsible__header").click(function () {
    const id = $(this).data("target") || $(this).attr("data-target");
